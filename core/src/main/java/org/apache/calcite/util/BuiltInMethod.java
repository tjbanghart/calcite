...
public enum BuiltInMethod {
  ...
  WCOJ_PREFIX(EnumerableDefaults.class, "wcojPrefix", List.class,
      int[][].class, TrieCache.class, int.class),
  WCOJ_WITH_SHARED_PREFIX(EnumerableDefaults.class, "wcojWithSharedPrefix",
      List.class, List.class, int[][].class, Function1.class, TrieCache.class,
